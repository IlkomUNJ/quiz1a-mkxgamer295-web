...
enum AdminPrompt{ VIEW_ACCOUNTS, CREATE_ACCOUNT, REMOVE_ACCOUNT, SYSTEM_REPORT, ADMIN_BACK};
using namespace std;
...
int main() {
    ...
    AdminPrompt adminPrompt = VIEW_ACCOUNTS;
        ...
        switch (prompt) {
            ...
            case ADMIN_LOGIN:
                ...
                if (username == ADMIN_USERNAME && password == ADMIN_PASSWORD) {
                    ...
                    while (prompt != EXIT) {
                        cout << "Select an option: " << endl;
                        cout << "1. view buyer and sellers" << endl;
                        cout << "2. create buyer or seller" << endl;
                        cout << "3. remove buyer or seller" << endl;
                        cout << "4. system report" << endl;
                        cout << "5. back" << endl;
                        int admchoice;
                        cin >> admchoice;
                        ...
                        switch (prompt) {
                            case VIEW_ACCOUNTS:
                                break;
                            case CREATE_ACCOUNT:
                                cout << "create buyer or seller selected." << endl;
                                break;
                            case REMOVE_ACCOUNT:
                                cout << "remove buyer or seller selected." << endl;
                                break;
                            case SYSTEM_REPORT:
                    ...
                    cout << "Admin login failed." << endl;
                     // return to main menu if login failed
                    break;
                }
